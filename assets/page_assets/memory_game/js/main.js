...
assets_base_path = "assets/page_assets/memory_game"
...
function setupCards() {
	...
	for (let i=0 ; i<=fruitList.length-1 ; i++){
		...
		cardList[i].innerHTML = `<div class="side"><img class="fruit_image" src="${assets_base_path}/images/lightning.png" alt="${fruitList[i]}"></div>
			    	<div class="side back"><img class="fruit_image" src="${assets_base_path}/images/${fruitList[i]}.png" alt="${fruitList[i]}"></div>`
	}
}
